...
namespace Nick.InferenceEngine.Net
{
    ...
    public class NV12Blob : IDisposable
    {
        ...
        public static implicit operator IntPtr(NV12Blob blob) => blob._blob;

        public dimensions_t Dimensions { get; }

        public NV12Blob(NativeMemory nativeMemory)
        {
            ie_blob_make_memory_nv12(nativeMemory.)
